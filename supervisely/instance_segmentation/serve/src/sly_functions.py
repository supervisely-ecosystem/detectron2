...
def inference_image_url(api: sly.Api, task_id, context, state, app_logger):
    ...
    ann_json = inference_image_path(image_path=local_image_path, project_meta=g.meta, context=context, state=state, app_logger=app_logger)
...
def inference_image_id(api: sly.Api, task_id, context, state, app_logger):
    ...
    ann_json = inference_image_path(image_path=image_path, project_meta=g.meta, context=context, state=state, app_logger=app_logger)
